...
<body>
	...
	<!-- <div class="top-bar_sub_w3layouts_agile">
		<h6>Student Mangement System </h6>
		<!-- <div class="pull-right">
			<h5><a class="sign" href="#" data-toggle="modal" data-target="#myModal2">Admin</a></h5>
			<h5><a class="sign" href="#" >Student Login</a></h5>
			...
			<div class="header-nav-agileits">
				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.html">Students Information</a></h1>
					</div>
						...
						<nav>
							<ul class="top_nav">
                                ...
                                @if (Auth::guard('student')->check())
                                    <li><a href="{{ route('student.dash') }}" class="active">Dashboard</a></li>
                                @else
                                    <li><a class="active" href="#" data-toggle="modal" data-target="#myModal2">Admin</a></li>
    								<li><a class="active" href="#" data-toggle="modal" data-target="#myModal3">Student Login</a></li>
                                @endif
                                @endauth
							</ul>
						</nav>
				...
				<div class="modal-header">
					...
					<div class="signin-form profile">
						...
						<div class="login-m_page_img">
							...
							<img src="{{ asset('new/images/model.jpg') }}" alt=" " class="img-responsive" />
				...
				<div class="modal-header">
					...
					<div class="signin-form profile">
						...
						<div class="login-m_page_img">
							...
							<img src="{{ asset('new/images/students.jpg') }}" alt=" " class="img-responsive" />

						</div>
						<div class="login-m_page">
							<h3 class="sign">Student Login</h3>
							<div class="login-form-wthree-agile">
	...
	<div class="contact-footer-w3layouts-agile">
		 ...
		 <div class="bottom-social-agileits-w3ls">
			...
			<b><p class="text-center" style="color:black">Copyright © <?php echo date("Y"); ?> . All Rights Reserved | Devloped by <a href="#">Cse 19th Batch</a> </p></b>
			<div class="clearfix"></div>
		</div>
	</div>
	<!--/footer -->
	...
	<script src="{{asset('new/js/responsiveslides.min.js')}}"></script>
	<script>
		$(function () {
	...
	<!--//search-bar-->
	<link rel="stylesheet" type="text/css" href="{{ asset('new/css/easy-responsive-tabs.css') }} " />
	<script src="{{ asset('new/js/easyResponsiveTabs.js') }}"></script>
	...
	<script type="text/javascript" src="{{asset('new/js/move-top.js')}}"></script>
	<script type="text/javascript" src="{{asset('new/js/easing.js')}}"></script>
	<script type="text/javascript">
	...
	<script type="text/javascript" src="{{ asset('new/js/bootstrap-3.1.1.min.js') }}"></script>
